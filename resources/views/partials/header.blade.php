<nav class="bg-white sticky z-10 w-full top-0 left-0 border-b border-gray-200 ">
    <div class="max-w-screen-2xl flex flex-wrap  items-center justify-between mx-auto p-4 ">
        <a href="#" class="flex items-center">
            <img src="{{URL::asset('img/logo.png')}}" class="h-9 mr-3" alt="Mading Logo" />
            <span class="self-center text-2xl  font-bold whitespace-nowrap ">Mading JeWePe 2023</span>
        </a>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
                ...
                <li>
                    <a href="/"
                        class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:hover:text-green-500  md:dark:hover:bg-transparent {{ ($title === 'Home') ? 'text-green-500' : ''}}"
                ...
                <li>
                    <a href="/artikel"
                        class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-green-700 md:p-0 md:dark:hover:text-green-500  md:dark:hover:bg-transparent {{($title === 'Artikel') ? 'text-green-500' : ''}}">
                        Artikel</a>
                </li>
            </ul>
        </div>
